...
export class Register extends Component {
    ...
    render() {
        return (
            <>
            {this.state.isRegistered && <Redirect to="/loginUser"/> }
            <div className="register-wrapper">
                <form className="hvr-float-shadow" onSubmit={this.onSubmit}>
                ...
                {this.state.errorMessage && <span className="text-danger">{this.state.errorMessage}</span>}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="email" id="email" className="form-control" onChange={this.onInputChange} required/>
                        </div>
                        <div className="form-group">
                        ...
                        <br/>
                        <Link to="/loginUser">Already have an account?</Link>
                    </div>
                </form>
            </div>
            </>
